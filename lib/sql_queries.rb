...
def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal
  # select the titles and the amount (over goal) of all projects that met funding goal
...
def selects_user_names_and_amounts_of_all_pledges_grouped_by_name_then_orders_them_by_the_summed_amount
  # Select user's names and amounts of all pledges. Grouped by name. Then ordered by sum amount.
...
def selects_the_category_names_and_pledge_amounts_of_all_pledges_in_the_music_category
  # Selects category names and ALL pledge amounts in the music category
...
def selects_the_category_name_and_the_sum_total_of_the_all_its_pledges_for_the_books_category
  # Selects the category name and sum total of all pledges in the book category
